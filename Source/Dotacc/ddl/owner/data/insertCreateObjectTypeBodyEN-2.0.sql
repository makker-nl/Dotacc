...
set define off
declare
  l_xsl_name xxx_xml_documents.docname%type := 'CreateObjectTypeBodyEN_2.0.xsl';
...
-->
 ...
 <!-- Member Names -->
  ...
  <xsl:variable name="cmtProcedureDelCascImpl" select="'Call the objects own del method.'"/>
