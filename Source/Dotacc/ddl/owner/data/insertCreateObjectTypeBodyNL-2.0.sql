...
set define off
declare
  l_xsl_name xxx_xml_documents.docname%type := 'CreateObjectTypeBodyNL_2.0.xsl';
...
-->
 ...
 <!-- Member Names -->
  ...
  <xsl:variable name="cmtProcedureDelCascImpl" select="'Call the object',$apos,'s own del method.'"/>
...
l_xsl_content_b clob := q'{  <!-- Insert into part of Member Procedure Insert-->
